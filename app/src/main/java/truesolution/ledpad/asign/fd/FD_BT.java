...
public class FD_BT {
	 ...
	 * The constant SAVE_COLOR_TEXT_ACTION.
	 */
	public static final byte SAVE_PICTURE     = (byte)(SAVE_COLOR_TEXT_ACTION + 1);
	/**
	 * The constant SAVE_COLOR_TEXT_ACTION.
	 */
	public static final byte SAVE_PICTURE_ACTION     = (byte)(SAVE_PICTURE + 1);
	/**
	...
	/**
	 * The constant SET_WIFI_CONNECT.
	 */
	public static final byte SET_WIFI_CONNECT            = (byte)0xB1;
	/**
	 * The constant GET_WIFI_CONNECT_INFO.
	 */
	public static final byte GET_WIFI_CONNECT            = (byte)0xB2;
	...
	public static final byte GET_BOARD_INFO				= (byte) 0x91;
	public static final byte GET_ROTATION_INFO			= (byte) 0xA0;
	public static final byte GET_BATTERY_INFO			= (byte) 0x98;
	public static final byte SET_PICTURE_START			= (byte) 0x14;
	public static final byte SET_PICTURE				= (byte) 0x15;
	public static final byte SET_PICTURE_END			= (byte) 0x16;
...
// (1+ 2 + 1 + 2 + 1);
	...
	/**
	 * The constant SIZE_FONT_COLOR.
	 */

	public static final int SIZE_FONT_COLOR = 3;

	/**
	 * The constant SIZE_BG_COLOR.
	 */

	public static final int SIZE_BG_COLOR = 3;
...
// Text Size
	 ...
	 * The constant SIZE_TEXT_COLOR.
	 */
	public static final int SIZE_WORD_LEN          	= 1;
...
// Multi Text
	...
	/**
	 * The constant Picture transmit Packet Loss
	 */
	public static final byte PICTURE_RECIVE_NACK        = (byte)0x12;
	/**
	 * The constant Picture transmit Packet perfect
	 */
	public static final byte PICTURE_RECIVE_ACK        = (byte)0x13;
	/**
	 * The constant Start Mode Setting
	 */
	public static final byte SET_START_MODE				= (byte) 0x92;
	/**
	 * The constant Flash Save Led Bright Setting
	 */
	public static final byte SAVE_LED_LEVEL				= (byte) 0x93;
	/**
	 * The constant To be used Mode Setting
	 */
	public static final byte SET_USE_MODE				= (byte) 0x94;
	/**
	 * The constant Preview Led Bright Setting
	 */
	public static final byte SET_LED_LEVEL				= (byte) 0x95;
	/**
	 * The constant Matrix Size 64x32 Setting
	 */
	public static final byte SET_MATRIX_64X32			= (byte) 0x96;
	/**
	 * The constant Matrix Size 32x64 Setting
	 */
	public static final byte SET_MATRIX_32X64			= (byte) 0x97;
	/**
	 * The constant Matrix Size 64x32 Flash Save
	 */
	public static final byte SAVE_ROTATION_64X32			= (byte) 0x99;
	/**
	 * The constant Matrix Size 32x64 Flash Save
	 */
	public static final byte SAVE_ROTATION_32X64			= (byte) 0x9A;

	/**
	 * Get Device Data
	 */
	public static final byte GET_MATRIX_PIXEL				= (byte) 0x9B;
}
